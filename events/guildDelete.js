...
module.exports = async (client, guild, member) => {
    ...
    const log_channel = client.channels.cache.get('837373548460769421');
    ...
    const embed = new MessageEmbed()
        ...
        log_channel.send(`(${client.guilds.cache.size}/100) <@!${client.user.id}> vient d'être retiré sur le serveur ${guild.name} :`, embed).catch(console.error);
